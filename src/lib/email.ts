...
export async function sendVerificationEmail(to: string, name: string, token: string) {
  ...
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      html: `
        <div style="font-family:'Century Gothic',CenturyGothic,'Didact Gothic',AppleGothic,sans-serif;max-width:480px;margin:0 auto;padding:24px;color:#050505;">
          <p style="font-family:'Century Gothic',CenturyGothic,'Didact Gothic',AppleGothic,sans-serif;font-size:12px;letter-spacing:2px;text-transform:uppercase;color:#1e50a0;">VALUX / HN</p>
          ...
          <p style="margin:28px 0;">
            <a href="${verifyUrl}" style="background:#1e50a0;color:#fff;padding:12px 22px;text-decoration:none;font-family:'Century Gothic',CenturyGothic,'Didact Gothic',AppleGothic,sans-serif;font-size:13px;letter-spacing:1px;">CONFIRMAR MI CUENTA</a>
          </p>
